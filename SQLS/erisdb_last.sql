...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2022 a las 06:24:16
...
(2022017, 'Jefferson', 'Ahimar', 'Av. Flores de Primavera 585', 'Masculino', 'Soltero(a)', '1999-09-11', 'SJL', 23, 'jeffersonahimar', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'jeffersonahimar@gmail.com', '920574430', 'Sistemas', '', ''),
(2022020, 'Wilmer', 'Wilmer', 'Wilmer', 'Femenino', 'Soltero(a)', '1995-01-17', 'Wilmer', 27, 'wilmer', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'sdsadas@asdas.com', 'Wilmer', 'Wilmer', '', '');
...
INSERT INTO `tblcompany` (`COMPANYID`, `COMPANYNAME`, `COMPANYRUC`, `COMPANYADDRESS`, `COMPANYCONTACTNO`, `COMPANYSTATUS`, `COMPANYUSER`, `COMPANYPASS`, `COMPANYDEPARTAMENTO`, `COMPANYPROVINCIA`, `COMPANYDISTRITO`, `COMPANYPHOTO`) VALUES
(8, 'Silfersystem', '20509726583', 'Av. Arequipa 1345', '92010156', 'habilitado', 'silfer', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'Lima', 'Lima', 'Lince', 'photos/23092022011238logo_silfer.jpg');
...
INSERT INTO `tbljob` (`JOBID`, `COMPANYID`, `CATEGORY`, `OCCUPATIONTITLE`, `REQ_NO_EMPLOYEES`, `SALARIES`, `DURATION_EMPLOYEMENT`, `QUALIFICATION_WORKEXPERIENCE`, `JOBDESCRIPTION`, `JOBTYPE`, `JOBSTATUS`, `DATEPOSTED`) VALUES
(6, 8, 'Tecnología', 'Prueba', 1, 200, '4 meses', '2 meses en puestos similares', 'Desarrollo Web PHP', 'Virtual', '', '2022-09-20 19:13:00');
