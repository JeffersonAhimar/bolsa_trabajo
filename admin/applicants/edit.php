...
<form class="form-horizontal span6  wow fadeInDown" action="controller.php?action=edit" method="POST">
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder="Primer Nombre" type="text" value="<?php echo $emp->FNAME; ?>" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="LNAME" name="LNAME" placeholder="Apellidos" value="<?php echo $emp->LNAME; ?>" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="MNAME" name="MNAME" placeholder="Segundo Nombre" value="<?php echo $emp->MNAME; ?>" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <textarea class="form-control input-sm" id="ADDRESS" name="ADDRESS" placeholder="Dirección" type="text" value="" required onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"><?php echo $emp->ADDRESS; ?></textarea>
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <textarea class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder="Lugar de Nacimiento" type="text" value="" required onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"><?php echo $emp->BIRTHPLACE; ?></textarea>
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder="Nro. de Contacto" type="text" any value="<?php echo $emp->TELNO; ?>" required onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder="Posición" type="text" any value="<?php echo $emp->POSITION; ?>" required onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="DATEHIRED">Fecha de Contratación:</label>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input type="Email" class="form-control input-sm" id="EMP_EMAILADDRESS" name="EMP_EMAILADDRESS" placeholder="Correo eléctronico" autocomplete="false" value="<?php echo  $emp->EMP_EMAILADDRESS; ?>" />
      </div>
    </div>
  </div>
