    ...
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <select class="form-control input-sm" id="COMPANYDEPARTAMENTO" name="COMPANYDEPARTAMENTO" onchange="cambiaProvincia()" required="">
          ...
          <option value="Amazonas" <?php echo ($res->COMPANYDEPARTAMENTO == 'Amazonas') ? 'selected="true"' : ''; ?>>Amazonas</option>
          <option value="Ancash" <?php echo ($res->COMPANYDEPARTAMENTO == 'Ancash') ? 'selected="true"' : ''; ?>>Ancash</option>
          <option value="Apurímac" <?php echo ($res->COMPANYDEPARTAMENTO == 'Apurímac') ? 'selected="true"' : ''; ?>>Apurímac</option>
          <option value="Arequipa" <?php echo ($res->COMPANYDEPARTAMENTO == 'Arequipa') ? 'selected="true"' : ''; ?>>Arequipa</option>
          <option value="Ayacucho" <?php echo ($res->COMPANYDEPARTAMENTO == 'Ayacucho') ? 'selected="true"' : ''; ?>>Ayacucho</option>
          <option value="Cajamarca" <?php echo ($res->COMPANYDEPARTAMENTO == 'Cajamarca') ? 'selected="true"' : ''; ?>>Cajamarca</option>
          <option value="Callao" <?php echo ($res->COMPANYDEPARTAMENTO == 'Callao') ? 'selected="true"' : ''; ?>>Callao</option>
          <option value="Cuzco" <?php echo ($res->COMPANYDEPARTAMENTO == 'Cuzco') ? 'selected="true"' : ''; ?>>Cuzco </option>
          <option value="Huancavelica" <?php echo ($res->COMPANYDEPARTAMENTO == 'Huancavelica') ? 'selected="true"' : ''; ?>>Huancavelica</option>
          <option value="Huánuco" <?php echo ($res->COMPANYDEPARTAMENTO == 'Huánuco') ? 'selected="true"' : ''; ?>>Huánuco</option>
          <option value="Ica" <?php echo ($res->COMPANYDEPARTAMENTO == 'Ica') ? 'selected="true"' : ''; ?>>Ica</option>
          <option value="Junín" <?php echo ($res->COMPANYDEPARTAMENTO == 'Junín') ? 'selected="true"' : ''; ?>>Junín</option>
          <option value="La_Libertad" <?php echo ($res->COMPANYDEPARTAMENTO == 'La_Libertad') ? 'selected="true"' : ''; ?>>La Libertad</option>
          <option value="Lambayeque" <?php echo ($res->COMPANYDEPARTAMENTO == 'Lambayeque') ? 'selected="true"' : ''; ?>>Lambayeque</option>
          <option value="Lima" <?php echo ($res->COMPANYDEPARTAMENTO == 'Lima') ? 'selected="true"' : ''; ?>>Lima</option>
          <option value="Loreto" <?php echo ($res->COMPANYDEPARTAMENTO == 'Loreto') ? 'selected="true"' : ''; ?>>Loreto</option>
          <option value="Madre_de_Dios" <?php echo ($res->COMPANYDEPARTAMENTO == 'Madre_de_Dios') ? 'selected="true"' : ''; ?>>Madre de Dios</option>
          <option value="Moquegua" <?php echo ($res->COMPANYDEPARTAMENTO == 'Moquegua') ? 'selected="true"' : ''; ?>>Moquegua</option>
          <option value="Pasco" <?php echo ($res->COMPANYDEPARTAMENTO == 'Pasco') ? 'selected="true"' : ''; ?>>Pasco</option>
          <option value="Piura" <?php echo ($res->COMPANYDEPARTAMENTO == 'Piura') ? 'selected="true"' : ''; ?>>Piura</option>
          <option value="Puno" <?php echo ($res->COMPANYDEPARTAMENTO == 'Puno') ? 'selected="true"' : ''; ?>>Puno</option>
          <option value="San_Martín" <?php echo ($res->COMPANYDEPARTAMENTO == 'San_Martín') ? 'selected="true"' : ''; ?>>San Martín</option>
          <option value="Tacna" <?php echo ($res->COMPANYDEPARTAMENTO == 'Tacna') ? 'selected="true"' : ''; ?>>Tacna</option>
          <option value="Tumbes" <?php echo ($res->COMPANYDEPARTAMENTO == 'Tumbes') ? 'selected="true"' : ''; ?>>Tumbes</option>
          <option value="Ucayali" <?php echo ($res->COMPANYDEPARTAMENTO == 'Ucayali') ? 'selected="true"' : ''; ?>>Ucayali</option>
        </select>
      </div>
    </div>
  </div>
...
<script>
  function cambiaProvincia() {
    ...
    var sel_departamento = document.getElementsByName("COMPANYDEPARTAMENTO")[0];
    var sel_provincia = document.getElementsByName("COMPANYPROVINCIA")[0];
    var sel_distrito = document.getElementsByName("COMPANYDISTRITO")[0];
