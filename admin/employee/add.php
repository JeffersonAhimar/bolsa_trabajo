                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                                      "Nro. de Contacto" type="text" any value="" required   autocomplete="off">
                                </div>
                              </div>
                            </div> 
