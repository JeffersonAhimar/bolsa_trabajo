...
<body class="hold-transition skin-blue fixed sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo web_root; ?>admin/company/" class="logo">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="<?php echo web_root; ?>admin/logout.php" class="btn btn-default btn-flat">Cerrar Sesión</a>
                  </div>
                </li>
              </ul>
            </li>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="<?php echo (currentpage() == 'user') ? "active" : false; ?>">
            <a href="<?php echo web_root; ?>admin/user/">
              <i class="fa fa-user"></i> <span>Administradores</span> </a>
          </li>
