...
<form class="form-horizontal span6" action="controller.php?action=add" method="POST">
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder="Nombres" type="text" value="">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input name="deptid" type="hidden" value="">
        <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder="Nombre de Usuario" type="text" value="">
      </div>
    </div>
  </div>
