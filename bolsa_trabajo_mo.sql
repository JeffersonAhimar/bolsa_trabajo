...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2022 a las 19:29:55
...
--
-- Base de datos: `bolsa_trabajo_mo`
--
...
INSERT INTO `tblcompany` (`COMPANYID`, `COMPANYNAME`, `COMPANYRUC`, `COMPANYADDRESS`, `COMPANYCONTACTNO`, `COMPANYSTATUS`, `COMPANYUSER`, `COMPANYPASS`, `COMPANYPAIS`, `COMPANYDEPARTAMENTO`, `COMPANYPROVINCIA`, `COMPANYDISTRITO`, `COMPANYPHOTO`) VALUES
(35, 'Silfersystem', '20509726583', 'Av. Arequipa 1345', '987959451', 'habilitado', 'silfer', 'e34375fd03c68a9dd50670f8806be9a50dcb7ecd', 1, '14', '135', '1353', '06102022061230_35_logo_silfersystem.png'),
(43, 'Compañia 1', '20123456789', 'Dirección 1', '912345678', 'habilitado', 'comp1', '1cfe4dae7181bcab07203e929a873d8b8c489b4c', 1, '6', '57', '593', ''),
(44, 'Compañia 2', '20223456789', 'Dirección 2', '922345678', 'deshabilitado', 'comp2', 'c3049ee10e28446cb65d4ac53a18f2ad6d3ad1bd', 1, '6', '66', '666', ''),
(45, 'Compañia 3', '20323456789', 'Dirección 3', '932345678', 'deshabilitado', 'comp3', 'f1162232d4c3a01e226cc15cab6e8719bde08a2e', 1, '6', '60', '620', ''),
(46, 'Compañia 4', '20423456789', 'Dirección 4', '942345678', 'deshabilitado', 'comp4', 'fc0303ca689435829ac0422b83fca3b2f75ac212', 1, '6', '62', '635', ''),
(47, 'Compañia 5', '20523456789', 'Dirección 5', '952345678', 'deshabilitado', 'comp5', 'e4091302f06345f49f0c4b5a39a487dbf8bc31b5', 1, '6', '62', '639', ''),
(48, 'Compañia 6', '20623456789', 'Dirección 6', '962345678', 'deshabilitado', 'comp6', 'd30fe87536b5f57e6c1fc0858b9ec73c7da97daf', 1, '6', '63', '647', '');
...
INSERT INTO `tbldepartamentos` (`idDepartamento`, `departamento`, `idPais`) VALUES
(1, 'AMAZONAS', 1),
(2, 'ANCASH', 1),
(3, 'APURIMAC', 1),
(4, 'AREQUIPA', 1),
...
--
-- Estructura de tabla para la tabla `tbldistrito`
--
...
--
-- Volcado de datos para la tabla `tbldistrito`
--

INSERT INTO `tbldistrito` (`idDistrito`, `distrito`, `idProvincia`) VALUES
(1, 'ARAMANGO', 1),
(2, 'COPALLIN', 1),
(3, 'EL PARCO', 1),
(4, 'IMAZA', 1),
...
INSERT INTO `tblpais` (`idPais`, `pais`, `nacionalidad`) VALUES
(1, 'PERU', 'PERUANA');
...
--
-- Volcado de datos para la tabla `tblprovincia`
--

INSERT INTO `tblprovincia` (`idProvincia`, `provincia`, `idDepartamento`) VALUES
(1, 'BAGUA', 1),
(2, 'BONGARA', 1),
(3, 'CHACHAPOYAS', 1),
(4, 'CONDORCANQUI', 1),
...
('0298311', 'Silfersystem Admin', 'silferadmin', 'e34375fd03c68a9dd50670f8806be9a50dcb7ecd', 'Administrador', ''),
('0298312', 'IESTP1', 'IESTP1', '81cd20ca26e3319e2b7c7c663713153bd216f3ce', 'IESTP', ''),
('0298313', 'IESTP2', 'IESTP2', 'cdbce0fc80aa9527730a4104e56576778d18c072', 'IESTP', ''),
('0298314', 'IESTP3', 'IESTP3', '31ecd061c81fe795c2f760e877d815703100481a', 'IESTP', ''),
...
--
-- Indices de la tabla `tbldistrito`
--
...
--
ALTER TABLE `tblcompany`
  MODIFY `COMPANYID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `tbldepartamentos`
  ADD CONSTRAINT `Pais.Departamento` FOREIGN KEY (`idPais`) REFERENCES `tblpais` (`idPais`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbldistrito`
--
ALTER TABLE `tbldistrito`
  ADD CONSTRAINT `Provincia.Distrito` FOREIGN KEY (`idProvincia`) REFERENCES `tblprovincia` (`idProvincia`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tblprovincia`
--
ALTER TABLE `tblprovincia`
  ADD CONSTRAINT `Provincia.Departamento` FOREIGN KEY (`idDepartamento`) REFERENCES `tbldepartamentos` (`idDepartamento`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
