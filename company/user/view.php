            ...
            <div class="col-md-8">
              ...
              <div class="col-md-8">
                <select class="form-control input-sm" id="U_DEPARTAMENTO" name="U_DEPARTAMENTO" onchange="cambiaProvincia()" required="">
                  ...
                  <option value="Amazonas" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Amazonas') ? 'selected="true"' : ''; ?>>Amazonas</option>
                  <option value="Ancash" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Ancash') ? 'selected="true"' : ''; ?>>Ancash</option>
                  <option value="Apurímac" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Apurímac') ? 'selected="true"' : ''; ?>>Apurímac</option>
                  <option value="Arequipa" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Arequipa') ? 'selected="true"' : ''; ?>>Arequipa</option>
                  <option value="Ayacucho" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Ayacucho') ? 'selected="true"' : ''; ?>>Ayacucho</option>
                  <option value="Cajamarca" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Cajamarca') ? 'selected="true"' : ''; ?>>Cajamarca</option>
                  <option value="Callao" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Callao') ? 'selected="true"' : ''; ?>>Callao</option>
                  <option value="Cuzco" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Cuzco') ? 'selected="true"' : ''; ?>>Cuzco </option>
                  <option value="Huancavelica" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Huancavelica') ? 'selected="true"' : ''; ?>>Huancavelica</option>
                  <option value="Huánuco" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Huánuco') ? 'selected="true"' : ''; ?>>Huánuco</option>
                  <option value="Ica" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Ica') ? 'selected="true"' : ''; ?>>Ica</option>
                  <option value="Junín" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Junín') ? 'selected="true"' : ''; ?>>Junín</option>
                  <option value="La_Libertad" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'La_Libertad') ? 'selected="true"' : ''; ?>>La Libertad</option>
                  <option value="Lambayeque" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Lambayeque') ? 'selected="true"' : ''; ?>>Lambayeque</option>
                  <option value="Lima" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Lima') ? 'selected="true"' : ''; ?>>Lima</option>
                  <option value="Loreto" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Loreto') ? 'selected="true"' : ''; ?>>Loreto</option>
                  <option value="Madre_de_Dios" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Madre_de_Dios') ? 'selected="true"' : ''; ?>>Madre de Dios</option>
                  <option value="Moquegua" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Moquegua') ? 'selected="true"' : ''; ?>>Moquegua</option>
                  <option value="Pasco" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Pasco') ? 'selected="true"' : ''; ?>>Pasco</option>
                  <option value="Piura" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Piura') ? 'selected="true"' : ''; ?>>Piura</option>
                  <option value="Puno" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Puno') ? 'selected="true"' : ''; ?>>Puno</option>
                  <option value="San_Martín" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'San_Martín') ? 'selected="true"' : ''; ?>>San Martín</option>
                  <option value="Tacna" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Tacna') ? 'selected="true"' : ''; ?>>Tacna</option>
                  <option value="Tumbes" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Tumbes') ? 'selected="true"' : ''; ?>>Tumbes</option>
                  <option value="Ucayali" <?php echo ($singleuser->COMPANYDEPARTAMENTO == 'Ucayali') ? 'selected="true"' : ''; ?>>Ucayali</option>
                </select>
              </div>
            </div>
          </div>
...
<script>
  function cambiaProvincia() {
    ...
    var sel_departamento = document.getElementsByName("U_DEPARTAMENTO")[0];
    var sel_provincia = document.getElementsByName("U_PROVINCIA")[0];
    var sel_distrito = document.getElementsByName("U_DISTRITO")[0];
  ...
  var opt_Cutervo = new Array("Seleccione el Distrito", "Callayuc", "Choros", "Cujillo", "Cutervo", "La Ramada", "Pimpingos", "Querocotillo", "San Andrés de Cutervo", "San Juan de Cutervo", "San Luis de Lucma", "Santa Cruz", "Santo Domingo de la Capilla", "Santo Tomás", "Socota", "Toribio Casanova");
