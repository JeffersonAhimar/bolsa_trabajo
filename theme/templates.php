    ...
    <header>
      <div class="topbar navbar-fixed-top">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+51) 914 943 017</p>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-4">
            <div class="widget">
              ...
              <p>
                <i class="icon-phone"></i> (+51) 914 943 017 <br>
                <i class="icon-envelope-alt"></i> contacto@silfersystem.com
              </p>
            </div>
          </div>
          <div class="col-md-4 col-sm-4">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <div class="copyright">
                <p>
                  <span>&copy; DRE Cajamarca 2022 Todos los derechos reservados.
                </p>
              </div>
            </div>
            <div class="col-lg-6">
